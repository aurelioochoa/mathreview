...
- **Una isla distinta por mundo, velero y personaje realistas (2026-09-24).** Cada mundo tiene su **bioma** (`three/walk/biomes.js`): dunas tropicales con laguna (Isla Numérica), colinas con campos de cultivo a surcos (Reino), cono de basalto con ríos de lava que laten y árboles secos (Volcán), terrazas escalonadas con foso (Castillo), jardín de setos (Laberinto), suelo lunar con cráteres y cristales (Estación), cordillera con cumbres nevadas que deja paso al muelle (Montañas) y recinto ferial con baldosas, carpas a rayas y farolas (Feria). El bioma decide la altura, los colores por zona (que se pintan en los vértices sobre una textura de detalle en grises), la vegetación y sus obstáculos; la isla pequeña del mapa usa la misma paleta y un detalle en miniatura para reconocerse desde el barco. El **velero** se construye por secciones como en un astillero (manga, proa afilada, quilla, arrufo, pintura antiincrustante y franja de flotación, cubierta de tablones, cabina con ojos de buey, mástil, botavara, mayor y foque con bolsa, jarcia, candeleros y grímpola) y escora al navegar; el mismo modelo aparece amarrado en cada embarcadero. El **personaje** tiene proporciones humanas: torso torneado, pelvis, piernas y brazos articulados en rodilla y codo, cuello, cabeza con ojos, cejas, nariz, boca, orejas y pelo, y una mochila con el emblema del avatar equipado; al caminar dobla rodillas y codos y gira el torso. La cámara a pie se acerca si un árbol, una roca o el monumento se cruzan, y no baja del suelo.
