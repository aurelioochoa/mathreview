...
describe('sidequests del Mundo 8', () => {
  it('hay 3 quests bien formadas', () => {
    expect(mundo8Quests).toHaveLength(3)
    for (const q of mundo8Quests) {
  ...
  it('cada fábrica produce 4 opciones distintas y correctAnswer válido (300 tiradas)', () => {
    for (const quest of mundo8Quests) {
