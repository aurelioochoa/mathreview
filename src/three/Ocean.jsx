...
export default function Ocean({ animate = true, color = '#3fa7e0', onClick }) {
  const geoRef = useRef()
  ...
  return (
    <mesh receiveShadow rotation={[-Math.PI / 2, 0, 0]} position={[-1, -0.55, -2]} onClick={onClick}>
      <planeGeometry ref={geoRef} args={[110, 80, 110, 80]} />
