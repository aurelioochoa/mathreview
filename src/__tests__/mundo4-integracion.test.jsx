...
// Verificación de integración del bucle jugable del Mundo 4: cruza contenido +
...
describe('integración: Mundo 4 jugable', () => {
  const world = findWorld('castillo-algebra')

  it('worlds exporta el Mundo 4 y findWorld lo resuelve', () => {
    expect(world).toBeTruthy()
    expect(worlds.map((w) => w.slug)).toContain('castillo-algebra')
    expect(world.id).toBe('mundo4')
  })

  it('tiene 5 niveles bien formados (briefing no vacío, reto con pick 3 y ≥3 fábricas)', () => {
