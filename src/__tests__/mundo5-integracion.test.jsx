...
// Verificación de integración del bucle jugable del Mundo 5: cruza contenido +
...
describe('integración: Mundo 5 jugable', () => {
  const world = findWorld('laberinto-sistemas')

  it('worlds exporta el Mundo 5 y findWorld lo resuelve', () => {
    expect(world).toBeTruthy()
    expect(worlds.map((w) => w.slug)).toContain('laberinto-sistemas')
    expect(world.id).toBe('mundo5')
  })
