...
// Verificación de integración del bucle jugable del Mundo 7: cruza contenido +
...
describe('integración: Mundo 7 jugable', () => {
  const world = findWorld('montanas-geometria')

  it('worlds exporta el Mundo 7 y findWorld lo resuelve', () => {
    expect(world).toBeTruthy()
    expect(worlds.map((w) => w.slug)).toContain('montanas-geometria')
    expect(world.id).toBe('mundo7')
  })

  it('tiene 4 niveles bien formados (briefing no vacío, reto con pick 3 y ≥3 fábricas)', () => {
