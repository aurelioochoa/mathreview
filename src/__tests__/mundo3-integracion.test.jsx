...
// Verificación de integración del bucle jugable del Mundo 3: cruza contenido +
...
describe('integración: Mundo 3 jugable', () => {
  const world = findWorld('volcan-potencias')

  it('worlds exporta el Mundo 3 y findWorld lo resuelve', () => {
    expect(world).toBeTruthy()
    expect(worlds.map((w) => w.slug)).toContain('volcan-potencias')
    expect(world.id).toBe('mundo3')
  })
